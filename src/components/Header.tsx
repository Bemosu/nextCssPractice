...
const SiteHeader = () => {
  ...
  return (
    <div className='flex w-full flex-col items-center gap-5 m-12  '>
        <ul className='flex flex-row gap-10'>
          <li className='relative'>
            ...
            {aboutstate && (<ul className="bg-white text-black w-auto py-[14px] px-5 rounded gap-[26px] shadow-md flex-wrap absolute max-md:relative max-md:flex-col max-md:shadow-none max-md:w-full max-md:px-0 animate-drop-down !flex min-w-[600px] max-md:min-w-0">
              <li>
